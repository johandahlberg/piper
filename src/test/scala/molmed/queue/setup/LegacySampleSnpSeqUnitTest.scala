...
class LegacySampleSnpSeqUnitTest {
    ...
    def testGetFastqs() {
        ...
        // Class under test
        val sample = new LegacySample(sampleName, setupXMLReader, illuminaXMLReportReader, 1, runFolderName)
    ...
    def testEqualsTrue() {
        // Setup
        val expected = new LegacySample(sampleName, setupXMLReader, illuminaXMLReportReader, 1, runFolderName)

        // Class under test
        val actual = new LegacySample(sampleName, setupXMLReader, illuminaXMLReportReader, 1, runFolderName)
    ...
    def testEqualsFalse() {
        // Setup
        val expected = new LegacySample("AnotherName", setupXMLReader, illuminaXMLReportReader, 1, runFolderName)
