 ...
 * Usage:
 * 	java -classpath <classpath> molmed.queue.setup.SetupFileCreator <output xml file>
 */
object SetupFileCreator extends App {
  ...
  val outputFile = try {
    ...
    case e: ArrayIndexOutOfBoundsException => throw new IllegalArgumentException("Missing output file. Usage is: java -classpath <classpath> molmed.apps.SetupFileCreator <output xml file>")
  }
