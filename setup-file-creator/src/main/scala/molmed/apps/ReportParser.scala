 ...
 *  
 * Usage is: java -classpath <classpath> apps.ReportParser <setup xml> <output file>
 */
object ReportParser extends App {

  val usage = "Missing input file. Usage is: java -classpath <classpath> apps.ReportParser <setup xml> <output file>"
